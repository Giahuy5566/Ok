...
local aa = {
    ...
    [22] = function()
        ...
        function g.New(h, i, j)
            ...
            search.Frame.Size = UDim2.new(1, -5, 0, 24)
    ...
    [50] = function()
        ...
        return {
            ...
            ElementBorder = Color3.fromRGB(9, 8, 8),
            InElementBorder = Color3.fromRGB(90, 90, 90),
            ElementTransparency = 0.87,
            ToggleSlider = Color3.fromRGB(249, 138, 138),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(236, 32, 32),
            DropdownFrame = Color3.fromRGB(106, 50, 50),
